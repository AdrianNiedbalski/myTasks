package OOP.ZDJavaAdvancedExc.Task3.Kompozycja;
...
public class SportShoe implements Shoe{
    ...
    public SportShoe(String name, double size, boolean isLeather, boolean isComfortable, Laces lacesColor, Sole soleMaterial) {
        this.name = name;
        this.size = size;
        this.isLeather = isLeather;
        this.isComfortable = isComfortable;
        this.laces = new Laces(laces.getColor());
        this.sole = new Sole(sole.getMaterial());
    }
